...
- Money columns: Numeric, default=0 unless explicitly nullable.
...
class EtlRun(Base):
    ...
    usd_rate_used: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    error_message: Mapped[str | None] = mapped_column(Text, nullable=True)
    opening_cash_m: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    reconciliation_residual_m: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
...
class MonthlyCashflow(Base):
    ...
    cash_in_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_suppliers_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_drawings_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_refunds_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_purchases_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_salaries_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_other_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_siyrafa_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    internal_transfers_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_total_operational_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    out_total_comprehensive_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    net_operating_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    net_total_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    cash_running_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class PerSupplierMonthly(Base):
    ...
    year_month: Mapped[str] = mapped_column(String(7), primary_key=True)
    paid_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    paid_iqd_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    paid_usd_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    recv_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class BalancesSnapshot(Base):
    ...
    balance_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    balance_iqd_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class InstallmentsSummary(Base):
    ...
    face_total_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    cash_paid_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    discount_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    remaining_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class InstallmentsAging(Base):
    ...
    amount_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class SeasonalIndex(Base):
    ...
    avg_value_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class ForecastBase(Base):
    ...
    value_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    cagr: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    mape: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
...
class SupplierCap(Base):
    ...
    monthly_cap_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    plan_low_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    plan_high_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    user_monthly_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class Assumption(Base):
    ...
    usd_rate: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    unexpected_reserve_m: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    income_growth_pct: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    in_growth_factor: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    out_growth_factor: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    cagr_floor: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    cagr_cap: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
...
class ScenarioAdjustment(Base):
    ...
    adjust_pct: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
    override_value_m: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
...
class PaymentPlan(Base):
    ...
    pool_for_suppliers_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    reserve_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class PaymentPlanLine(Base):
    ...
    planned_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    cap_applied_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    allocated_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    actual_paid_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
    variance_m: Mapped[Numeric] = mapped_column(Numeric, default=0)
...
class AppSettings(Base):
    ...
    neg_threshold_m: Mapped[Numeric | None] = mapped_column(Numeric, nullable=True)
